...
shared_state::SharedState(CHAIN 3, ID 2, F 1);
...
fd1
-> b1::FTBlock(1.3.1.1,2.0.1.1)
-> td1;

// fd2
// -> b2::FTBlock(1.3.2.2,2.0.2.2)
// -> td2;
//
// fd3
// -> b3::FTBlock(1.3.3.3,2.0.3.3)
// -> td3;
//
// fd4
// -> b4::FTBlock(1.3.4.4,2.0.4.4)
// -> td4;
//
// fd5
// -> b5::FTBlock(1.3.5.5,2.0.5.5)
// -> td5;
//
// fd6
// -> b6::FTBlock(1.3.6.6,2.0.6.6)
// -> td6;
//
// fd7
// -> b7::FTBlock(1.3.7.7,2.0.7.7)
// -> td7;
//
// fd8
// -> b8::FTBlock(1.3.8.8,2.0.8.8)
// -> td8;
