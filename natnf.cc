...
//Packet *natnf::simple_action(Packet *p) {
void 
natnf::push(int port, Packet *p) {
//    LOG("--------------------");
...
//    printf("before!!\n");
	...
	printf("is IP_FIRSTFRAG %d", !IP_FIRSTFRAG(iph));
	printf("transport length: %d", rp->transport_length());
    	printf("delete one \n");
	rp->kill();
//    	printf("delete one \n");
	return;
...
int natnf::configure(Vector<String> &conf, ErrorHandler *errh) {
