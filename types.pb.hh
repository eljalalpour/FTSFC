...
class TimestampState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:FTSFC.TimestampState) */ {
 public:
  ...
  inline TimestampState* New() const { return New(NULL); }

  TimestampState* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static TimestampState* default_instance_;
};
// -------------------------------------------------------------------
...
class PiggyBackState : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:FTSFC.PiggyBackState) */ {
 public:
  ...
  inline PiggyBackState* New() const { return New(NULL); }

  PiggyBackState* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  inline void set_has_last_commit();
  inline void clear_has_last_commit();
  inline void set_has_timestamp();
  inline void clear_has_timestamp();
  inline void set_has_state();
  inline void clear_has_state();
  ...
  void InitAsDefaultInstance();
  static PiggyBackState* default_instance_;
};
// -------------------------------------------------------------------
...
class PiggyBackMessage : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:FTSFC.PiggyBackMessage) */ {
 public:
  ...
  inline PiggyBackMessage* New() const { return New(NULL); }

  PiggyBackMessage* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
 ...
 private:
  ...
  void InitAsDefaultInstance();
  static PiggyBackMessage* default_instance_;
};
// ===================================================================
